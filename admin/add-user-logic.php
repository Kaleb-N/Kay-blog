...
if (isset($_POST['submit'])) {
    ...
    if (!$firstname) {
        ...
        $_SESSION['add-user'] = 'Password should be min of 8 characters';
    } elseif (!$avatar['name']) {
        ...
        if ($createpassword !== $confirmpassword) {
            ...
            if (mysqli_num_rows($user_check_result) > 0) {
                ...
                // work on avatar
                // rename avatar
                $time = time(); // using time to make each image unique
                $avatar_name = $time . $avatar['name']; // append avatar name to current time
    ...
    if (isset($_SESSION['add-user'])) {
        ...
        $_SESSION['add-user-data'] = $_POST; // send back invalid details to the page instead of clearing them
