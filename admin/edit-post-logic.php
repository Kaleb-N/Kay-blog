...
if (isset($_POST['submit'])) {
    ...
    if (!$title) {
        ...
        if ($thumbnail['name']) {
            ...
            // rename image
            $time = time(); // make each name upload unique
            ...
            if (in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 5000000) {
                    ...
                    $_SESSION['edit-post'] = "File size too big, should be less than 5mb";
                }
            } else {
    ...
    if (isset($_SESSION['edit-post'])) {
        // redirect back (with form data) to manage form page if form is invalid
